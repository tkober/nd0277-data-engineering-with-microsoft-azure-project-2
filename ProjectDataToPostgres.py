...
def main():
    ...
    ########################################
    host = os.getenv(key="AZURE_POSTGRES_HOST", default="127.0.0.1")
    user = os.getenv(key="AZURE_POSTGRES_USER", default="postgres")
    password = os.getenv(key="AZURE_POSTGRES_PASSWORD", default="postgres")

    # Create a new DB
    sslmode = os.getenv(key="AZURE_POSTGRES_SSL_MODE", default="require")
    dbname = "postgres"
